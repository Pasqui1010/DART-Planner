# NOTE: This file is copied verbatim from `src/planning/dial_mpc_planner.py`
# and kept here as the canonical legacy implementation.  See that file for
# the complete header and implementation details.
