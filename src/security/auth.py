...
def require_role(required_role: Role):
    ...
    def role_checker(current_user: User = Depends(AuthManager.get_current_active_user)):
...
def require_permission(permission: str):
    ...
    def permission_checker(current_user: User = Depends(AuthManager.get_current_active_user)):
