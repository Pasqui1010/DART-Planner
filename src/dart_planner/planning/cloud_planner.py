...
class CloudPlanner:
    ...
    def __init__(self):
        ...
        self.logger.info("Cloud Planner initialized.")
        self.plan_count = 0
    ...
    def plan_trajectory(
        ...
        """
        self.logger.info(f"Cloud planner received state. Planning a path near {goal_position}...")
        ...
        self.logger.info("Circular trajectory planned successfully.")
        self.plan_count += 1
        return Trajectory(
