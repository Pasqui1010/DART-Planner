...
class UserService:
    ...
    def create_user(self, db: Session, username: str, password: str, role: Role) -> models.User:
    ...
    def update_user_role(self, db: Session, user_id: int, new_role: Role) -> Optional[models.User]:
    ...
    def revoke_token(self, db: Session, jti: str, user_id: int):
