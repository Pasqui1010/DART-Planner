...
class ControlLoopProfiler:
    ...
    def analyze_bottlenecks(self):
        ...
        print(
            f"{'Component':<25} {'Mean (ms)':<10} {'P95 (ms)':<10} {'Threshold':<10} {'Status'}"
        )
        print("-" * 70)
        ...
        for comp in components:
            ...
            print(
                f"{comp['name']:<25} {comp['mean']:<10.2f} {comp['p95']:<10.2f} "
        ...
        print("-" * 70)
        print(
            f"{'TOTAL LOOP TIME':<25} {total_time:<10.2f} {'':<10} {'1.0':<10} "
    ...
    def export_profile_data(self, filename="control_loop_profile.csv"):
        ...
        with open(filename, "w") as f:
            ...
            for component in self.timings.keys():
                ...
                if stats:
                    f.write(
                        f"{component},{stats['mean']:.3f},{stats['std']:.3f},"
...
def run_profiled_control_test():
    ...
    print(
        f"⏱️  Running {test_duration}s profiling test at {1/dt:.0f}Hz target frequency..."
    )
