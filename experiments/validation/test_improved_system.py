...
def main():
    ...
    if response in ['y', 'yes']:
        duration = 20.0
        try:
            duration_input = input(f"⏱️  Test duration in seconds (default {duration}): ").strip()
            if duration_input:
        ...
        print("👋 Test cancelled. You can run this script anytime to test the improved system.")
