"""
Standalone test for motor mixer with consistent SI units.

This test avoids importing the full hardware module to prevent AirSim dependency issues.
"""
...
# Import only the motor mixer and related classes
